...
public class ChromeActivity2 {
		...
		AppiumDriver<MobileElement> driver = null;
		 ...
		 public void Credentials(String username,String password,String credentials) {
			 
			 //find the username and password input fields on the page and enter the credentials
